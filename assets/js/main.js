...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(b) {
    var e = /\blang(?:uage)?-([\w-]+)\b/i, j = 0, a = {
        ...
        languages: {
            extend: function(e, b) {
                var c = a.util.clone(a.languages[e]), d;
                for (d in b)
                    c[d] = b[d];
                return c
            },
            insertBefore: function(f, i, d, e) {
                var h = (e = e || a.languages)[f], c = {}, b, g, j;
                for (b in h)
            ...
            DFS: function i(f, g, j, c) {
                ...
                e = a.util.objId;
                for (d in f)
                    f.hasOwnProperty(d) && (g.call(f, d, f[d], j || d),
                    b = f[d],
                    h = a.util.type(b),
                    "Object" !== h || c[e(b)] ? "Array" !== h || c[e(b)] || (c[e(b)] = !0,
                    i(b, g, d, c)) : (c[e(b)] = !0,
                    i(b, g, null, c)))
            }
        },
        ...
        highlightAllUnder: function(d, e, f) {
            ...
            b.elements = Array.prototype.slice.apply(b.container.querySelectorAll(b.selector)),
        ...
        highlightElement: function(d, l, f) {
            var g = a.util.getLanguage(d), k = a.languages[g], h, c, j;
            ...
            !c.code)
                return a.hooks.run("complete", c),
                void (f && f.call(c.element));
            a.hooks.run("before-highlight", c),
            c.grammar ? l && b.Worker ? (j = new Worker(a.filename),
        ...
        highlight: function(d, e, f) {
            ...
            return a.hooks.run("before-tokenize", b),
                ...
                for (n in v)
                    if (v.hasOwnProperty(n) && v[n]) {
                        ...
                        for (p = 0; p < o.length; ++p) {
                            ...
                            C = !!e.greedy,
                            H = e.alias,
                            C && !e.pattern.global && (G = e.pattern.toString().match(/[imsuy]*$/)[0],
                            e.pattern = RegExp(e.pattern.source, G + "g"));
                            for (A = e.pattern || e,
                            b = J.next,
                            d = I; b !== j.tail && !(m && d >= m.reach); d += b.value.length,
                            b = b.next) {
                                if (k = b.value,
                                j.length > y.length)
                                    return;
                                if (!(k instanceof c)) {
                                    ...
                                    C) {
                                        ...
                                        b.value instanceof c)
                                            continue;
                                        for (q = b; q !== j.tail && (g < F || "string" == typeof q.value); q = q.next)
                                            u++,
                                            g += q.value.length;
                                        u--,
                                        k = y.slice(d, g),
    ...
    function h(c, d, e, f) {
        var a, b;
        return c.lastIndex = d,
        a = c.exec(e),
        a && f && a[1] && (b = a[1].length,
        a.index += b,
        a[0] = a[0].slice(b)),
        a
    }
    ...
    function l(d, b, e) {
        for (var a = b.next, c = 0; c < e && a !== d.tail; c++)
            a = a.next;
        (b.next = a).prev = b,
        d.length -= c
    }
    ...
    c.stringify = function i(c, f) {
        ...
        for (h in b.attributes)
            e += " " + h + '="' + (b.attributes[h] || "").replace(/"/g, "&quot;") + '"';
        return "<" + b.tag + ' class="' + b.classes.join(" ") + '"' + e + ">" + b.content + "</" + b.tag + ">"
    }
    ,
    !b.document)
        return b.addEventListener && (a.disableWorkerMessageHandler || b.addEventListener("message", function(e) {
    ...
    return d && (a.filename = d.src,
    d.hasAttribute("data-manual") && (a.manual = !0)),
    !a.manual && (i = document.readyState,
...
!function(a) {
    ...
    for (f = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"],
                ...
                if (c.language === d && c.tokenStack) {
                    ...
                    !function m(i) {
                        for (var j = 0, g, o, r, l, n, k, p, s, q, h; j < i.length && !(e >= f.length); j++)
                            g = i[j],
                            "string" == typeof g || g.content && "string" == typeof g.content ? (o = f[e],
                            r = c.tokenStack[o],
                            ...
                            "string" == typeof g ? i.splice.apply(i, [j, 1].concat(h)) : g.content = h)) : g.content && m(g.content);
                        return i
                    }(c.tokens)
                }
            }
...
Prism.hooks.add("wrap", function(a) {
    var b, c;
    "groovy" === a.language && "string" === a.type && (b = a.content[0],
    "'" != b && (c = /([^\\])(?:\$(?:\{.*?\}|[\w.]+))/,
    "$" === b && (c = /([^\$])(?:\$(?:\{.*?\}|[\w.]+))/),
...
!function(a) {
    ...
    f = d.length; c < f; c++)
        ...
        a.languages[b.language] && (e["filter-" + b.filter] = {
...
!function(a) {
    var b = /\/\*[\s\S]*?\*\/|\/\/.*|#(?!\[).*/, c = [{
        ...
        alias: "boolean"
    }, /\b[A-Z_][A-Z0-9_]*\b(?!\s*\()/, /\b(?:null)\b/i], d = /\b0b[01]+(?:_[01]+)*\b|\b0o[0-7]+(?:_[0-7]+)*\b|\b0x[\da-f]+(?:_[\da-f]+)*\b|(?:\b\d+(?:_\d+)*\.?(?:\d+(?:_\d+)*)?|\B\.\d+)(?:e[+-]?\d+)?/i, e = /<?=>|\?\?=?|\.{3}|\??->|[!=]=?=?|::|\*\*=?|--|\+\+|&&|\|\||<<|>>|[?~]|[/^|%*&<>.+-]=?/, f = /[{}\[\](),:;]/, g, h;
    a.languages.php = {
        delimiter: {
            pattern: /\?>$|^<\?(?:php(?=\s)|=)?/i,
            alias: "important"
    ...
    Object.defineProperty(b, "addSupport", {
        value: function(b, c) {
            ...
            b.forEach(function(b) {
                !function(g, f) {
                    var e = "doc-comment", d = a.languages[g], b, h, c, i;
                    if (d)
                        if (b = d[e],
                        b || (h = {
                            "doc-comment": {
                        ...
                        b = (d = a.languages.insertBefore(g, "comment", h))[e]),
                        b instanceof RegExp && (b = d[e] = {
                            pattern: b
                        }),
                        Array.isArray(b))
                            for (c = 0,
                            i = b.length; c < i; c++)
                                b[c]instanceof RegExp && (b[c] = {
                                    pattern: b[c]
                                }),
                                f(b[c]);
                        else
...
!function(a) {
    ...
    for (e = ["function", "function-variable", "method", "method-variable", "property-access"],
    c = 0; c < e.length; c++)
        f = e[c],
        b = a.languages.javascript[f],
        "RegExp" === a.util.type(b) && (b = a.languages.javascript[f] = {
            pattern: b
        }),
        g = b.inside || {},
...
!function(a) {
    ...
    a.languages.kt = a.languages.kotlin,
    a.languages.kts = a.languages.kotlin
}(Prism),
!function(a) {
    var b = /\\(?:[^a-z()[\]]|[a-z*]+)/i
      , c = {
...
!function(a) {
    ...
    a.languages.puppet.string.inside["double-quoted"].inside.interpolation = b
}(Prism),
...
!function(a) {
    var d = a.util.clone(a.languages.javascript), b, c;
    ...
    c = function(g) {
        for (var e = [], f = 0, d, i, h; f < g.length; f++)
            d = g[f],
            i = !1,
            ("string" != typeof d && ("tag" === d.type && d.content[0] && "tag" === d.content[0].type ? "</" === d.content[0].content[0].content ? 0 < e.length && e[e.length - 1].tagName === b(d.content[0].content[1]) && e.pop() : "/>" === d.content[d.content.length - 1].content || e.push({
                tagName: b(d.content[0].content[1]),
                openedBraces: 0
            }) : 0 < e.length && "punctuation" === d.type && "{" === d.content ? e[e.length - 1].openedBraces++ : 0 < e.length && 0 < e[e.length - 1].openedBraces && "punctuation" === d.type && "}" === d.content ? e[e.length - 1].openedBraces-- : i = !0),
            (i || "string" == typeof d) && 0 < e.length && 0 === e[e.length - 1].openedBraces) && (h = b(d),
            f < g.length - 1 && ("string" == typeof g[f + 1] || "plain-text" === g[f + 1].type) && (h += b(g[f + 1]),
            g.splice(f + 1, 1)),
            0 < f && ("string" == typeof g[f - 1] || "plain-text" === g[f - 1].type) && (h = b(g[f - 1]) + h,
            g.splice(f - 1, 1),
            f--),
...
!function(a) {
    var c = a.util.clone(a.languages.typescript), b;
    a.languages.tsx = a.languages.extend("jsx", c),
    b = a.languages.tsx.tag,
    b.pattern = RegExp("(^|[^\\w$]|(?=</))(?:" + b.pattern.source + ")", b.pattern.flags),
    b.lookbehind = !0
}(Prism),
!function(e) {
    var b = {
...
!function() {
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        ...
        Prism.hooks.add("before-sanity-check", function(c) {
            var b = c.element.parentElement, e = b && b.getAttribute("data-line"), d;
            b && e && /pre/i.test(b.nodeName) && (d = 0,
        ...
        Prism.hooks.add("complete", function g(c) {
            var a = c.element.parentElement, e = a && a.getAttribute("data-line"), i, j;
            a && e && /pre/i.test(a.nodeName) && (clearTimeout(f),
            i = Prism.plugins.lineNumbers,
            j = c.plugins && c.plugins.lineNumbers,
            b(a, "line-numbers") && i && !j ? Prism.hooks.add("line-numbers", g) : (d(a, e)(),
            f = setTimeout(h, 1)))
        }),
    ...
    function b(b, a) {
        return a = " " + a + " ",
        -1 < (" " + b.className + " ").replace(/[\n\t]/g, " ").indexOf(a)
    }
    function g(a) {
        a()
    }
    function d(c, l, t) {
        var s = (l = "string" == typeof l ? l : c.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean), r = +c.getAttribute("data-line-offset") || 0, q = (i() ? parseInt : parseFloat)(getComputedStyle(c).lineHeight), j = b(c, "line-numbers"), f = c.querySelector("code"), p = j ? c : f || c, d = [], n = f && p != f ? function(d, b) {
        ...
        if (s.forEach(function(f) {
            var i = f.split("-"), b = +i[0], e = +i[1] || b, a = c.querySelector('.line-highlight[data-range="' + f + '"]') || document.createElement("div"), g, h, k, l;
            d.push(function() {
                a.setAttribute("aria-hidden", "true"),
                a.setAttribute("data-range", f),
                a.className = (t || "") + " line-highlight"
            }),
            j && Prism.plugins.lineNumbers ? (g = Prism.plugins.lineNumbers.getLine(c, b),
            h = Prism.plugins.lineNumbers.getLine(c, e),
            g && (k = g.offsetTop + n + "px",
            d.push(function() {
                a.style.top = k
            })),
            h && (l = h.offsetTop - g.offsetTop + h.offsetHeight + "px",
            d.push(function() {
                a.style.height = l
            }))) : d.push(function() {
    ...
    function h() {
        var b = location.hash.slice(1), f, g, c;
        a(".temporary.line-highlight").forEach(function(a) {
            a.parentNode.removeChild(a)
        }),
        f = (b.match(/\.([\d,-]+)$/) || [, ""])[1],
        f && !document.getElementById(b) && (g = b.slice(0, b.lastIndexOf(".")),
        c = document.getElementById(g),
        c && (c.hasAttribute("data-line") || c.setAttribute("data-line", ""),
        d(c, f, "temporary ")(),
        e && document.querySelector(".temporary.line-highlight").scrollIntoView()))
    }
}(),
!function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        var a = "line-numbers"
          ...
          , e = Prism.plugins.lineNumbers = {
            getLine: function(d, b) {
                ...
                if ("PRE" === d.tagName && d.classList.contains(a))
                    if (e = d.querySelector(".line-numbers-rows"),
                    e)
                        return c = parseInt(d.getAttribute("data-start"), 10) || 1,
                        f = c + (e.children.length - 1),
                        b < c && (b = c),
                        f < b && (b = f),
                        g = b - c,
                        e.children[g]
          ...
          , d = void 0;
        window.addEventListener("resize", function() {
            e.assumeViewportIndependence && d === window.innerWidth || (d = window.innerWidth,
            b(Array.prototype.slice.call(document.querySelectorAll("pre." + a))))
        }),
        Prism.hooks.add("complete", function(e) {
            var f, d, g, h, i, j;
            e.code && (f = e.element,
            d = f.parentNode,
            d && /pre/i.test(d.nodeName) && !f.querySelector(".line-numbers-rows") && Prism.util.isActive(f, a) && (f.classList.remove(a),
            d.classList.add(a),
            h = e.code.match(c),
            i = h ? h.length + 1 : 1,
    ...
    function b(a) {
        if (0 != (a = a.filter(function(b) {
            ...
            var b = a.map(function(b) {
                var d = b.querySelector("code"), e = b.querySelector(".line-numbers-rows"), a, f, g;
                if (d && e)
                    return a = b.querySelector(".line-numbers-sizer"),
            ...
            b.forEach(function(c) {
                for (var d = c.sizer, b = c.lineHeights, e = 0, a = 0; a < b.length; a++)
                    void 0 === b[a] && (b[a] = d.children[e++].getBoundingClientRect().height)
            }),
            b.forEach(function(a) {
                var b = a.sizer
...
!function() {
    var b, a, c, d, e;
    "undefined" != typeof self && self.Prism && self.document && (b = [],
    a = {},
    c = function() {}
    ,
    ...
    d = Prism.plugins.toolbar.registerButton = function(d, c) {
        ...
        e = "function" == typeof c ? c : function(b) {
            var a;
            return "function" == typeof c.onClick ? ((a = document.createElement("button")).type = "button",
            a.addEventListener("click", function() {
                c.onClick.call(this, b)
            })) : "string" == typeof c.url ? (a = document.createElement("a")).href = c.url : a = document.createElement("span"),
    ...
    e = Prism.plugins.toolbar.hook = function(f) {
        var d = f.element.parentNode, e, g, h, i;
        d && /pre/i.test(d.nodeName) && !d.parentNode.classList.contains("code-toolbar") && (e = document.createElement("div"),
        ...
        i = function(a) {
            for (; a; ) {
                ...
                if (null != b)
                    return (b = b.trim()).length ? b.split(/\s*,\s*/g) : [];
                a = a.parentElement
            }
        }(f.element),
        i && (h = i.map(function(b) {
            return a[b] || c
        })),
    ...
    ,
    d("label", function(e) {
        var a = e.element.parentNode, b, c, d;
        if (a && /pre/i.test(a.nodeName) && a.hasAttribute("data-label")) {
            d = a.getAttribute("data-label");
            try {
                c = document.querySelector("template#" + d)
            } catch (a) {}
            return c ? b = c.content : (a.hasAttribute("data-url") ? (b = document.createElement("a")).href = a.getAttribute("data-url") : b = document.createElement("span"),
            b.textContent = d),
            b
        }
    }),
    ...
    if ("undefined" != typeof self && self.Prism && self.document)
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("show-language", function(c) {
                var d = c.element.parentNode, b, e, f;
                if (d && /pre/i.test(d.nodeName))
                    if (e = d.getAttribute("data-language") || a[c.language] || ((b = c.language) && (b.substring(0, 1).toUpperCase() + b.substring(1)).replace(/s(?=cript)/, "S")),
                    e)
                        return f = document.createElement("span"),
                        f.textContent = e,
                        f
            })
        } else
